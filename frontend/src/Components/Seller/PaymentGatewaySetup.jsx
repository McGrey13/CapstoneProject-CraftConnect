          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">Simulation Mode</p>
              </div>
            </div>
            <button
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm text-blue-800 font-medium">Connect your {config.name} Account</p>
              ...
              <div className="text-center mb-6">
                <div className={`h-20 w-20 rounded-full bg-gradient-to-br ${config.bgGradient} mx-auto flex items-center justify-center text-white mb-4`}>
                  <Phone className="h-10 w-10" />
                </div>
                <h3 className="text-xl font-semibold text-[#5c3d28]">Enter Your Mobile Number</h3>
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="phone" className="text-[#5c3d28] font-medium text-base">
                    Mobile Number
                  </Label>
                  <div className="relative mt-2">
                    ...
                    <Input
                      ...
                      className="pl-10 border-2 focus:border-blue-500 text-lg py-6"
                      autoFocus
                    />
                  </div>
              ...
              <Button
                ...
                className={`w-full bg-gradient-to-r ${config.bgGradient} hover:opacity-90 text-white py-6 text-lg mt-6`}
              >
                {isConnecting ? (
                  <>
            ...
            <div className="space-y-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm text-yellow-800 font-medium">OTP Verification</p>
              ...
              <div className="text-center mb-6">
                <div className={`h-16 w-16 rounded-full bg-gradient-to-br ${config.bgGradient} mx-auto flex items-center justify-center text-white mb-3`}>
                  <Lock className="h-8 w-8" />
                </div>
                <h3 className="text-lg font-semibold text-[#5c3d28]">Verify Your Identity</h3>
                <p className="text-sm text-gray-600 mt-1">
                  Enter the 6-digit code sent to
                </p>
                <p className="text-sm font-bold text-[#a4785a] mt-1">
                  {credentials.phone}
                </p>
              </div>

              <div>
                <Label htmlFor="otp" className="text-[#5c3d28] font-medium">
                  OTP Code
                </Label>
                <Input
                  id="otp"
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className={`flex-1 bg-gradient-to-r ${config.bgGradient} hover:opacity-90 text-white`}
                >
                  {isConnecting ? (
                    <>
          ...
          {step === 3 && connectionSuccess && (
            <div className="space-y-6 text-center py-6">
              <div className={`h-20 w-20 rounded-full bg-gradient-to-br ${config.bgGradient} mx-auto flex items-center justify-center animate-bounce`}>
                <CheckCircle2 className="h-10 w-10 text-white" />
              </div>

              <div>
                <h3 className="text-2xl font-bold text-[#5c3d28] mb-2">
                ...
                <CardContent className="p-4">
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-[#a4785a] text-base">{credentials.phone}</span>
                    </div>
                    <div className="flex justify-between items-center">
              ...
              <Button
                ...
                className={`w-full bg-gradient-to-r ${config.bgGradient} hover:opacity-90 text-white`}
              >
                Finish Setup
              </Button>
            </div>
