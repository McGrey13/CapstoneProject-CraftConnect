...
const NotificationModal = ({ show, type, message, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className={`${getBgColor()} border-2 rounded-lg shadow-xl p-4 max-w-sm`}
        style={{ 
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-900" style={{ color: '#111827', fontWeight: '500' }}>{message}</p>
          </div>
          <button
            onClick={() => {
              setIsVisible(false);
