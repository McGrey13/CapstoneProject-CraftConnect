...
const AdminNavbar = ({
  ...
  return (
    <nav className="w-full h-16 bg-white border-b border-gray-200 px-4 fixed top-0 left-0 right-0 z-[9999]">
      <div className="h-full flex items-center justify-between max-w-full">
        ...
        {/* Right Side */}
        <div className="flex items-center space-x-2 flex-shrink-0 navbar-right">
          {/* Notifications */}
