...
// Renamed the function to ApprovedProducts to be more accurate with what it does.
// If you want to handle pending products, a separate component is recommended.
              ...
              <TableRow key={product.id}>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    {/* The fix is here: added bg-white to the DropdownMenuContent */}
